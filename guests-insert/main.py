...
def postgres_insert(db, pubsub_msg):
    ...
    ins = (
        tbl.insert().values(
            ...
            acceptable_shelter_types=pubsub_msg.get('acceptable_shelter_types', VALUE_NOT_PROVIDED),
            ...
            is_ukrainian_nationality=pubsub_msg.get('is_ukrainian_nationality', VALUE_NOT_PROVIDED),
